...
let s:base09 = '#ff9700' "215
let s:base0A = '#f3f99d' "229
let s:base0B = '#a4e400' "84
let s:base0C = '#62d8f1' "123
let s:base0D = '#57c7ff' "81
let s:base0E = '#bd93f9' "205
...
" Insert mode
let s:I1 = [ s:base00 , s:base0A , 235 , 84 ]
let s:I2 = [ s:base0A , s:base00 , 84 , 235 ]
let s:I3 = [ s:base0A , s:base00 , 84 , 235 ]
let s:I4 = [ s:base0A , 84 ]

" Visual mode
let s:V1 = [ s:base00 , s:base0E , 235 , 229 ]
let s:V2 = [ s:base0E , s:base00 , 229 , 235 ]
let s:V3 = [ s:base0E , s:base00 , 229 , 235 ]
let s:V4 = [ s:base0E , 229 ]
