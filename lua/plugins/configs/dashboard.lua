...
M.config = function()
  ...
  local plugin_count = {
    type = "text",
    val = "└─ " .. kind.cmp_kind.Module .. " " .. plugins ..
      " plugins in total ─┘",
  ...
  local buttons = {
    ...
    val = {
      ...
      button("s", " " .. kind.cmp_kind.Text .. " Ripgrep",
             ":Telescope live_grep<CR>"),
      button("r", " " .. kind.icons.clock .. " Recents",
             ":Telescope oldfiles<CR>"),
      button("b", " " .. kind.icons.buffer .. " Buffers",
             ":Telescope buffers<CR>"),
      button("o", " " .. kind.icons.settings .. " Options",
  ...
  local opts = {
    layout = {
      {type = "padding", val = 1}, section.header, {type = "padding", val = 2},
      section.heading, section.plugin_count, {type = "padding", val = 1},
      -- section.top_bar,
