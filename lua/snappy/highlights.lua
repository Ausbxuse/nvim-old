local highlight = {
  ...
  Normal=             {fg = C.ui_1,                bg =      Config.transparent_background and "NONE" or C.ui_10},
  ...
  SpellBad=           {fg = C.red,                 bg =     'NONE', style = 'italic'},
  ...
  SignColumn=         {fg = C.ui_12,               bg =  Config.transparent_background and "NONE" or C.blue},
