local highlight = {
  NormalPopupPrompt     = {fg = C.fg_highlight,    bg = "#191b20",    style = "bold"},
  NormalPopupSubtle     = {fg = C.ui_6,            bg = "#191b20"},
  NormalFloat           = {fg = C.fg,              bg = "#191b20"},
  Normal                = {fg = C.ui_1,            bg = Config.transparent_background and "NONE" or C.ui_11},
  ...
  MatchParen            = {fg = Config.transparent_background and "NONE" or C.ui_11,            bg = C.ui_8},
  ...
  SpellBad              = {fg = C.orange,             bg = "NONE",        style = "underline"},
  ...
  VertSplit             = {fg = C.ui_9,            bg = "NONE",        style = "bold"},
  ...
  ColorColumn           = {fg = Config.transparent_background and "NONE" or C.ui_11,            bg = C.ui_9},
  ...
  SignColumn            = {fg = C.ui_12,           bg = "NONE" or C.ui_11},
  WildMenu              = {fg = Config.transparent_background and "NONE" or C.ui_11,            bg = C.ui_4},
  IncSearch             = {fg = C.ui_10,           bg = C.yellow},
  Visual                = {fg = Config.transparent_background and "NONE" or C.ui_11,            bg = C.bg_visual},
  VisualBold            = {fg = Config.transparent_background and "NONE" or C.ui_11,            bg = C.bg_visual,   style = "bold"},
  ...
  PmenuSbar             = {fg = Config.transparent_background and "NONE" or C.ui_11,            bg = C.bg_alt},
  PmenuThumb            = {fg = C.pmenu_thumb,     bg = C.pmenu_thumb},
  Section               = {fg = C.magenta,         bg = Config.transparent_background and "NONE" or C.ui_11,        style = "bold"},
  ...
  Conceal               = {fg = C.blue,            bg = Config.transparent_background and "NONE" or C.ui_11},
  ...
  NotifyERRORBody       = {                        bg = Config.transparent_background and "NONE" or C.ui_11},
  NotifyWARNBody        = {                        bg = Config.transparent_background and "NONE" or C.ui_11},
  NotifyINFOBody        = {                        bg = Config.transparent_background and "NONE" or C.ui_11},
  NotifyDEBUGBody       = {                        bg = Config.transparent_background and "NONE" or C.ui_11},
  NotifyTRACEBody       = {                        bg = Config.transparent_background and "NONE" or C.ui_11},
  NotifyBackground       = { fg = Config.transparent_background and "NONE" or C.ui_11,                       bg = "#000000"},
  texTitleArg           = {fg = C.fg,              bg = Config.transparent_background and "NONE" or C.ui_11},
