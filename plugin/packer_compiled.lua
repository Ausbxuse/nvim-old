...
_G.packer_plugins = {
  ...
  ["compe-tabnine"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/compe-tabnine"
  },
  ["emmet-vim"] = {
    loaded = true,
  ...
  firenvim = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/firenvim"
  },
  ["friendly-snippets"] = {
    loaded = true,
  ...
  ["vim-startify"] = {
    loaded = true,
    path = "/home/peter/.local/share/nvim/site/pack/packer/start/vim-startify"
  },
  ["vim-vsnip"] = {
    loaded = true,
